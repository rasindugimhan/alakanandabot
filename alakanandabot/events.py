...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import alakanandabot.events

        path = Path(f"alakanandabot/modules/{shortname}.py")
        name = "alakanandabot.modules.{}".format(shortname)
        ...
        mod.alakanandabot = alakanandabot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["alakanandabot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "alakanandabot/modules/*.py"
