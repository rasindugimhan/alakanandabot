...
import alakanandabot.modules.sql.notes_sql as sql
from alakanandabot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from alakanandabot.__main__ import DATA_IMPORT
from alakanandabot.modules.helper_funcs.chat_status import user_admin
from alakanandabot.modules.helper_funcs.alternate import typing_action

# from alakanandabot.modules.rules import get_rules
import alakanandabot.modules.sql.rules_sql as rulessql

# from alakanandabot.modules.sql import warns_sql as warnssql
import alakanandabot.modules.sql.blacklist_sql as blacklistsql
from alakanandabot.modules.sql import disable_sql as disabledsql

# from alakanandabot.modules.sql import cust_filters_sql as filtersql
# import alakanandabot.modules.sql.welcome_sql as welcsql
import alakanandabot.modules.sql.locks_sql as locksql
from alakanandabot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("alakanandabot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("alakanandabot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `alakanandabot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("alakanandabot{}.backup".format(chat_id))  # Cleaning file
