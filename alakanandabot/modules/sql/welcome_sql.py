...
from alakanandabot.modules.helper_funcs.msg_types import Types
from alakanandabot.modules.sql import BASE, SESSION
from sqlalchemy import BigInteger, Boolean, Column, Integer, String, UnicodeText

DEFAULT_WELCOME = "Hey {first}, ആരാ? എവിടുന്നാ? എന്താ ചെയ്യുന്നേ? എല്ലാം പറയൂ..."
DEFAULT_GOODBYE = "എവിടെയൊക്കെ പോയാലും കറങ്ങി തിരിഞ്ഞ് ഇവിടെ തന്നെ എത്തും."
